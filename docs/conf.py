# -*- coding: utf-8 -*-
#
# Django Workshop documentation build configuration file, created by
...
try:
    if tags.has('exclude_changelog'):
        exclude_patterns.append('changelog.rst')
except NameError:
    pass
...
html_sidebars = {
    '**': ['localtoc.html', 'relations.html', 'sourcelink.html',
        'languages.html', 'support.html', 'links.html', 'searchbox.html']
}
...
# pages.
html_context = {
    'no_disqus': ['search', 'todo', 'copyright']
}
